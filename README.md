...
1. send file:<br>
   first you have to run server file like normal then run your pc code with command :<br>
   sendFile.py "YOUR_FILE_NAME" "send" <br>
...
3. get file: <br>
   the same way with send file, you have to run server code and on your pc run : <br>
   sendFile.py "YOUR_FILE_NAME_YOU_WANT_TO_GET" "get"
